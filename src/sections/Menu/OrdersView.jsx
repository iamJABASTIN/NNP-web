...
const OrdersView = ({ activeOrderId, status }) => {
  ...
  if (!activeOrderId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-12">
        <div className="w-24 h-24 border-4 border-black/10 flex items-center justify-center rounded-none-none mb-8">
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto animate-in slide-in-from-bottom duration-500">
      ...
      <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_#000000] rounded-none-none relative overflow-hidden">
            ...
            return (
              <div key={step.id} className="flex items-center gap-8 relative z-10">
                <motion.div 
                   ...
                   className={`w-14 h-14 border-4 border-black flex items-center justify-center rounded-none-none transition-colors duration-500 ${
                ...
                <div className="flex flex-col">
                  ...
                  {isCurrent && (
                    <motion.span 
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="text-[10px] font-bold text-accent px-2 py-0.5 bg-black rounded-none w-fit mt-1 uppercase tracking-tighter"
                    >
                      Current Status
                    </motion.span>
                  )}
      ...
      <div className="mt-12 p-6 bg-black text-white border-4 border-black rounded-none-none flex items-center justify-between shadow-[8px_8px_0px_#f2ca50]">
         <div className="flex flex-col">
