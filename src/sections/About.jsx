...
const About = () => (
  <section id="legacy" className="py-24 px-8 md:px-24 bg-muted relative text-black">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
      ...
      >
        <div className="absolute -top-10 -left-10 w-full h-full border-[12px] border-accent/20 z-0"></div>
        <img 
          alt="Artisan Chef" 
      ...
      <div className="w-full md:w-1/2 space-y-10">
        <h2 className="text-5xl font-black uppercase tracking-tighter border-l-8 border-black pl-8">The Modular<br />Legacy</h2>
