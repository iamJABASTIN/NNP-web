...
const SidebarItem = ({ icon: Icon, label, active = false, onClick, shortcut }) => (
  <div 
    onClick={onClick}
  ...
  >
    ...
    <div className="flex-1 flex items-center justify-between">
      ...
      {shortcut && (
        <span className="text-[10px] font-bold text-black/30 border border-black/20 px-1.5 py-0.5 rounded">
          {shortcut}
        </span>
      )}
    </div>
